...
void Camera::Input(GLFWwindow* window)
{
	...
	{
		Direction = glm::rotate(Direction, glm::radians(50*speed), Up);
	}
	...
	{
		Direction = glm::rotate(Direction, glm::radians(speed*50), glm::normalize(glm::cross(Direction, Up)));
	}
